...
# На 14.09.23 я заканчиваю работу с данным проектом, дальше буду деплоить его, изменю этот комент, когда захочу что-то добавить/поменять
# сам сайт будет находится по примерной ссылке https://thesimplelife.pythonanywhere.com/
# Следить за самим проектом можно на моем гите, все будет в пинах, ну или вот линк : https://github.com/NEZuko1337/TheSimpleLifeSite
